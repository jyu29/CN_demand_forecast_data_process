        ...
        stage("cluster provisioning") {
            ...
            build job: "EMR-CREATE-PERSISTENT-CLUSTER",
                parameters: [
                    ...
                    string(name: "instanceTypeMaster", value: "c4.2xlarge"),
                    string(name: "masterNodeDiskSize", value: "64"),
                    string(name: "nbrCoreOnDemand", value: "3"),
                    string(name: "nbrCoreSpot", value: "0"),
                    string(name: "instanceTypeCore", value: "r4.4xlarge"),
                    string(name: "coreNodeDiskSize", value: "32"),
                    string(name: "nbrTaskNode", value: "0"),
                    string(name: "instanceTypeTask", value: "c4.2xlarge"),
                    string(name: "taskNodeDiskSize", value: "32"),
